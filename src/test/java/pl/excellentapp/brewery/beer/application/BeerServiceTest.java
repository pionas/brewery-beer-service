...
class BeerServiceTest {
    ...
    void findAll_ShouldReturnListOfBeers() {
        ...
        final var beers = List.of(
                createBeer(UUID.fromString("1b4e28ba-2fa1-4d3b-a3f5-ef19b5a7633b"), "Classic Lager", BeerStyle.LAGER, "1234567890", 10, 50, BigDecimal.valueOf(8.49), 1, OFFSET_DATE_TIME, OFFSET_DATE_TIME),
                createBeer(UUID.fromString("2c4f2ed6-bd1d-4f9d-82c6-6b975b5cf5b3"), "Golden Pilsner", BeerStyle.PILSNER, "2345678901", 12, 40, BigDecimal.valueOf(9.99), 1, OFFSET_DATE_TIME, OFFSET_DATE_TIME),
                createBeer(UUID.fromString("3a8e0e2f-587d-4b3c-b1c9-27f5d6c3627a"), "Dark Stout", BeerStyle.STOUT, "3456789012", 8, 30, BigDecimal.valueOf(11.99), 1, OFFSET_DATE_TIME, OFFSET_DATE_TIME),
                createBeer(UUID.fromString("4c9e7a3b-84e7-4f8e-95e2-cd2f1d56e6b7"), "Salty Gose", BeerStyle.GOSE, "4567890123", 5, 25, BigDecimal.valueOf(10.49), 1, OFFSET_DATE_TIME, OFFSET_DATE_TIME),
                createBeer(UUID.fromString("5d3f8e7c-9f2b-42e1-908d-cf3d1e678e9b"), "Robust Porter", BeerStyle.PORTER, "5678901234", 6, 20, BigDecimal.valueOf(12.49), 1, OFFSET_DATE_TIME, OFFSET_DATE_TIME),
                createBeer(UUID.fromString("6e8f9d4c-7c8a-45d1-8b4c-ed3f5a7b6e9d"), "Amber Ale", BeerStyle.ALE, "6789012345", 9, 35, BigDecimal.valueOf(10.99), 1, OFFSET_DATE_TIME, OFFSET_DATE_TIME),
                createBeer(UUID.fromString("7f1b3c2d-8e9f-41b2-94c8-ef3d7a6b5c9f"), "Hefeweizen Wheat", BeerStyle.WHEAT, "7890123456", 7, 28, BigDecimal.valueOf(9.49), 1, OFFSET_DATE_TIME, OFFSET_DATE_TIME),
                createBeer(UUID.fromString("8a2d4e6f-9b3c-4e2f-b7d1-2c3f5a8e7b6d"), "Hoppy IPA", BeerStyle.IPA, "8901234567", 8, 32, BigDecimal.valueOf(11.79), 1, OFFSET_DATE_TIME, OFFSET_DATE_TIME),
